        ...
        <Parallax.Layer offset={2.42} speed={0.1} className={styles.windows}>
          ...
          >
            <Window>
              ...
              <h4>
                {" "}
                > На хакатоне будет поставлена единственная задача - image
                inpainting.
              </h4>
              <br />
              <h4>
                Командам надо предложить алгоритм, который лучше всех
                восстановит пробелы в изображениях.
              </h4>
            </Window>
          </div>
        </Parallax.Layer>
