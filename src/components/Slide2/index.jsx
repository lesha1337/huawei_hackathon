    ...
    return (
      <>
        <Parallax.Layer
          ...
          speed={0}
          className={"bg_layer"}
          style={{ backgroundColor: "#6c6e9f", backgroundSize: "cover" }}
        />
