    ...
    return (
      <>
        <Parallax.Layer
          ...
          speed={0}
          className={"bg_layer"}
          style={{ background: "#2e1d4b", backgroundSize: "cover" }}
        />
        ...
        <Parallax.Layer offset={0.45} speed={0.1} className={styles.windows}>
          ...
          >
            <Window>
              <h1>IMAGE INPAINTING ONLINE HACKATHON</h1>

              <a
                href="https://docs.google.com/forms/d/e/1FAIpQLSe6-4Z7wqGKZr4G54QAx3Oqi79oAWDFGLYL9zIMh8OWo_LSaw/viewform"
